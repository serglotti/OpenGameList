System.register(["./auth.service", "@angular/core", "@angular/router"], function(exports_1, context_1) {
    "use strict";
    ...
    var auth_service_1, core_1, router_1;
    var AppComponent;
    return {
        setters:[
        ...
        execute: function() {
            AppComponent = (function () {
                function AppComponent(router, authService) {
                    ...
                    this.title = "Account Quality Index";
                }
